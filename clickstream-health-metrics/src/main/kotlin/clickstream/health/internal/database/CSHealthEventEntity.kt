...
public data class CSHealthEventEntity(
    ...
    public companion object {
        @RestrictTo(RestrictTo.Scope.LIBRARY_GROUP)
        public fun CSHealthEvent.dtoMapTo(): CSHealthEventEntity {
        ...
        @RestrictTo(RestrictTo.Scope.LIBRARY_GROUP)
        public fun CSHealthEventEntity.mapToDto(): CSHealthEvent {
        ...
        @RestrictTo(RestrictTo.Scope.LIBRARY_GROUP)
        public fun List<CSHealthEventEntity>.mapToDtos(): List<CSHealthEvent> {
            return this.map { healthEvent -> healthEvent.mapToDto() }
        }

        @RestrictTo(RestrictTo.Scope.LIBRARY_GROUP)
        public fun List<CSHealthEvent>.dtosMapTo(): List<CSHealthEventEntity> {
