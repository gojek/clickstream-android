...
./gradlew :clickstream-event-listener:assemble && ./gradlew :clickstream-event-listener:publishReleasePublicationToSonatypeRepository --max-workers 1 closeAndReleaseSonatypeStagingRepository
